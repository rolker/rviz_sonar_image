...
public:
  ...
  void addMessage(const marine_acoustic_msgs::msg::RawSonarImage::ConstSharedPtr msg, uint32_t start_row, uint32_t end_row, int beam_number, const Ogre::Vector3& position, const Ogre::Quaternion& orientation );
